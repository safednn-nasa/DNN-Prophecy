...
def test(data,
    ...
    if not training:
        ...
        dataloader = create_dataloader(path, imgsz, batch_size, 64, single_cls=opt.single_cls, pad=0.5, rect=True)[0]
    ...
    for batch_i, (img, targets, paths, shapes) in enumerate(tqdm(dataloader, desc=s)):
        ...
        with torch.no_grad():
            ...
            # DEBUG
            # print(f'output after non_max_sup: {output}')
