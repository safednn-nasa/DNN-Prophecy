...
- -type, --type of rules to be extracted: 0: rules based on model output (such as predicted labels), 1: rules for correct vs incorrect model behavior, 2: rules for correct classification to
-  					 each label and incorrect classification, 3: rules for labels provided as an input array.
