...
def train(hyp, opt, device, tb_writer=None, wandb=None):
    ...
    # Trainloader
    dataloader, dataset = create_dataloader(train_path, imgsz, batch_size, gs, single_cls=opt.single_cls,
    ...
    if rank in [-1, 0]:
        ...
        testloader = create_dataloader(test_path, imgsz_test, batch_size*2, gs, single_cls=opt.single_cls,
